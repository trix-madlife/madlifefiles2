local Keys = {
  ...
  function LeaveInstance()
	  if Instance.host ~= nil then
		  ...
		  if #Instance.players > 1 then
			  ASD.ShowNotification(_U('left_instance'))
		  end
  ...
  AddEventHandler('instance:onPlayerEntered', function(instance, player)
	  ...
	  ASD.ShowNotification(_('entered_into', playerName))
  end)
  ...
  AddEventHandler('instance:onPlayerLeft', function(instance, player)
	  ...
	  ASD.ShowNotification(_('left_out', playerName))
  end)
  ...
  AddEventHandler('instance:onInvite', function(instance, type, data)
	  ...
	  Citizen.CreateThread(function()
		  ...
		  if InstanceInvite ~= nil then
			  ASD.ShowNotification(_U('invite_expired'))
			  InstanceInvite = nil
		  end
	  end)
  end)
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  if InstanceInvite ~= nil then
			  ASD.ShowHelpNotification(_U('press_to_enter'))
		  else
			  Citizen.Wait(500)
		  end
  ...
  Citizen.CreateThread(function()
	  while true do
		  ...
		  if InstanceInvite ~= nil and IsControlJustReleased(0, Keys['E']) then
			  ...
			  ASD.ShowNotification(_U('entered_instance'))
			  InstanceInvite = nil
