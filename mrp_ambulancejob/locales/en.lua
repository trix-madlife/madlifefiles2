Locales['en'] = {
  ...
  ['vehicleshop_bought'] = 'you have bought ~b~%s~s~ for ~r~$%s~s~',
  ...
  ['revive_complete'] = 'you have revived ~b~%s~s~',
  ['revive_complete_award'] = 'you have revived ~b~%s~s~ and earned ~g~$%s~s~!',
  ['heal_inprogress'] = 'you are healing!',
  ['heal_complete'] = 'you have healed ~b~%s~s~',
