Locales['en'] = {
	...
	['spacer1'] = 'If Vehicle is NOT here Check Impound You Fuck!!!',
	['spacer2'] = '| Plate | Vehicle Name | Location |',
	['spacer3'] = '| Plate | Vehicle Name |',
	['you_paid'] = 'You paid $',
	['not_enough_money'] = 'You do not have enough money You Broke Fuck!',
	...
	['cannot_store_vehicle'] = 'You can not store this Vehicle You Fuck!',
	['no_vehicle_to_enter'] = 'There is no Vehicle to store in the Garage You Fuck.',
	['vehicle_in_garage'] = 'Your Vehicle is stored in the Garage You Fuck.',
	-- Cars
